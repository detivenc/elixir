...
export type CompanyResourceSchema = {
  __type: "Resource";
  __primitiveFields: "id" | "cik" | "name" | "ticker" | "exchangeId";
  id: UUIDv7;
  cik: number;
  name: string;
  ticker: string;
  exchangeId: UUID | null;
  exchange: { __type: "Relationship"; __resource: ExchangeResourceSchema | null; };
};



// Exchange Schema
export type ExchangeResourceSchema = {
  __type: "Resource";
...
export type CompanyFilterInput = {
  ...
  exchange?: ExchangeFilterInput;

};
export type ExchangeFilterInput = {
  and?: Array<ExchangeFilterInput>;
  or?: Array<ExchangeFilterInput>;
  not?: Array<ExchangeFilterInput>;
...
export async function listCompanies<Fields extends ListCompaniesFields>(
  ...
  return executeActionRpcRequest<ListCompaniesResult<Fields>>(
    payload,
    config
  );
}
